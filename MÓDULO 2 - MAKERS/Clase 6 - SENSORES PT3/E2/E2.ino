...
const int LED_X_POS = 4;  // Cambiado a azul
const int LED_X_NEG = 3;  // Cambiado a rojo
const int LED_Y_POS = 6;  // Cambiado a amarillo
const int LED_Y_NEG = 5;  // Cambiado a verde
