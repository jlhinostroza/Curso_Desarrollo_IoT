...
#define NUM_DIGITOS 1      // Número de dígitos en el display
#define PIN_DIGITO 34      // Pin para controlar el display entero

#define PIN_SEG_A 5        // Pin A del display de 7 segmentos
#define PIN_SEG_B 18       // Pin B del display de 7 segmentos
#define PIN_SEG_C 19       // Pin C del display de 7 segmentos
#define PIN_SEG_D 21       // Pin D del display de 7 segmentos
#define PIN_SEG_E 22       // Pin E del display de 7 segmentos
#define PIN_SEG_F 13       // Pin F del display de 7 segmentos
#define PIN_SEG_G 12       // Pin G del display de 7 segmentos

SevSeg sevseg;             // Objeto para controlar el display de 7 segmentos
IRrecv receptorIR(PIN_IR); // Objeto para recibir señales infrarrojas
decode_results resultados; // Almacena los resultados del decodificador IR

void setup() {
  byte digitosPins[] = {PIN_DIGITO};
  ...
  sevseg.begin(COMMON_CATHODE, NUM_DIGITOS, digitosPins, segmentPins, false);
