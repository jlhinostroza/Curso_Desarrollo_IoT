...
const int ledPin_3 = 14;

const char *ssid = "WIFI_AP_ESP32";   //Se puede cambiar el nombre si se desea
const char *password = "";            //Se puede cambiar la contraseña si se desea
